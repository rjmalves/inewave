...
class BlocoVolInicialSubsistema(Section):
    ...
    def __init__(self, previous=None, next=None, data=None) -> None:
        ...
        campos_volumes: List[Field] = [
            FloatField(5, 21 + i * 7, 1) for i in range(15)
        ]
...
class BlocoRestricoesEletricasEspeciais(Section):
    """
    Bloco com a escolha da consideração, ou não, das restrições
    elétricas especiais.
    """
...
class BlocoFuncaoProducaoUHE(Section):
    """
    Bloco com a escolha da consideração, ou não, da função de produção
