...
class Enavazs(SectionFile):
    ...
    def series(self) -> Optional[pd.DataFrame]:
        ...
        """
        sections = [r for r in self.data.of_type(SecaoDadosEnavazs)]
        if len(sections) > 0:
