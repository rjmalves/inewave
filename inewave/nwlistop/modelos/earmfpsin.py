...
class LeituraEarmfpSIN(LeituraBlocos):
    """
    Realiza a leitura dos arquivos earmfpsin.out
    existentes em um diretório de saídas do NEWAVE.

    Esta classe contém o conjunto de utilidades para ler
    e interpretar os campos de arquivos earmfpsin.out, construindo
    objetos `EarmfpSIN` cujas informações são as mesmas dos arquivos.
