...
class GhfphexatAnos(TabelaSeriePatamarAnual):
    """
    Bloco com as informações das tabelas de geração segundo a FPH
    exata da usina nos pontos de operação por mês/ano de estudo.
    """
    ...
    COLUMNS = [
        ...
        ColumnDef(MESES_DF[i], FloatField(9, 14 + 9 * i, 2))
