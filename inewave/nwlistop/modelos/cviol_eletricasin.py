...
class CviolEletricasinAnos(TabelaSeriePatamarAnual):
    """
    Bloco com as informações das tabelas de custo de violação das
    restrições elétricas para o SIN por mês/ano de estudo.
    """
