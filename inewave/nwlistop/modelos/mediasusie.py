...
class TabelaMediasusie(Section):
    """
    Bloco com o conteúdo da tabela existente no arquivo `MEDIAS-USIE.CSV`.
    """
    ...
    def __eq__(self, o: object) -> bool:
        if not isinstance(o, TabelaMediasusie):
            return False
        bloco: TabelaMediasusie = o
        if not all(
            [
