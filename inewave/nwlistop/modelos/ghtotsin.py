...
class BlocoGeracaoHidraulicaSIN(Bloco):
    """
    ...
    def __eq__(self, o: object):
        if not isinstance(o, BlocoGeracaoHidraulicaSIN):
            return False
        bloco: BlocoGeracaoHidraulicaSIN = o
...
class LeituraGHTotSIN(LeituraBlocos):
    ...
    e interpretar os campos de arquivos ghtotsin.out, construindo
    objetos `GHTotSIN` cujas informações são as mesmas dos arquivos.
    ...
    def _cria_blocos_leitura(self) -> List[Bloco]:
        return [BlocoGeracaoHidraulicaSIN()]
